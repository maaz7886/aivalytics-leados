...
export default function LeadTable() {
  ...
  const filteredLeads = leads.filter((lead) => {
    ...
    if (selectedView === 'Details Sent') return matchesSearch && matchesProgram && matchesStage && lead.crmStage === 'Details sent';
    if (selectedView === 'Payment Pending') return matchesSearch && matchesProgram && matchesStage && (lead.crmStage === 'Payment Link Sent' || lead.paymentStatus === 'Unpaid');
                    ...
                    <td className="p-3.5 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1.5 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 font-bold text-xs rounded-lg shadow-xs transition-all cursor-pointer"
                        >
                          View Brief
                        </button>
                        <button
