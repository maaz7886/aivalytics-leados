...
const initialLeads: Lead[] = [
  {
    id: 'lead-meta-abhishek-raneja',
    fullName: 'Abhishek Raneja',
    phone: '+918857041481',
    email: 'learn.ardigital@gmail.com',
    city: 'Bengaluru',
    state: 'Karnataka',
    country: 'India',
    source: 'Meta Lead Ads Form',
    metaCampaign: 'AI-PM_Meta_Direct',
    metaAdSet: 'Project_Managers_5-8Yrs',
    metaAd: 'AI_Native_Workflow_Ad',
    campaignId: 'cmp_meta_pm_2026',
    dateCaptured: '2026-09-26 11:30',
    dateOfFillingForm: '2026-09-26',
    createdTime: '2026-09-26 11:30',
    programId: 'ai-pm',
    programName: 'AI-Native Project Management',
    professionalStatus: 'Working Professional',
    currentRole: 'project_/_program_management',
    currentCompany: 'Digital Operations',
    industry: 'Technology & Project Management',
    yearsOfExperience: 6,
    experience: '5–8_years',
    currentResponsibilities: 'Managing project workflows, sprint delivery, and team operations.',
    currentSkillSet: ['Project Management', 'Program Delivery', 'Stakeholder Management'],
    currentAiUsageLevel: 'i_am_not_using_ai_professionally_yet',
    aiUsage: 'i_am_not_using_ai_professionally_yet',
    primaryGoal: 'increase_my_earning_potential',
    goal: 'increase_my_earning_potential',
    desiredRole: 'AI-Native Project & Program Manager',
    expectedTimeline: 'immediately',
    mainChallenge: "i_don't_know_what_ai_skills_are_actually_relevant",
    blocker: "i_don't_know_what_ai_skills_are_actually_relevant",
    whyNow: 'Wants to increase earning potential immediately with relevant AI skills.',
    expectedOutcome: 'Build practical AI agent workflows and advance compensation.',
    comments: 'Form Qualification: 5–8 yrs experience. Not using AI yet. Goal: Increase earning potential. Blocker: irrelevant skills confusion. Investment: ₹34,999 budget objection. Preferred call time: 6 PM – 9 PM.',
    investment: '₹34,999_is_currently_outside_my_budget',
    education: 'Graduate / Professional',
    priority: 'P1',
    qualificationStatus: 'Qualified Prospect',
    objection: '₹34,999 is currently outside my budget',
    preferredBatch: 'Upcoming Cohort',
    preferredContactTime: '6_pm_–_9_pm',
    paymentLink: 'https://pages.razorpay.com/aivalytics-aipm-34999',
    aiRecommendation: 'Position EMI/installment option (₹11,666/mo) and focus on immediate earning potential uplift.',
    assignedSalesperson: 'Alex Rivera',
    crmStage: 'New Lead',
    leadTemperature: 'Hot',
    lastContacted: 'Not Contacted',
    nextFollowUp: new Date(Date.now() + 86400000).toISOString().substring(0, 10) + ' 18:00',
    numberOfCalls: 0,
    numberOfFollowUps: 0,
    ...
    leadScore: 91,
    leadHealthScore: 95,
    aiSummary: 'Abhishek is a seasoned PM with 5–8 years experience looking to increase earning potential immediately. Main hurdle is understanding which AI skills are genuinely relevant, plus price sensitivity around ₹34,999. Recommended approach: demonstrate tangible agentic PM workflows and offer 3-month no-cost EMI plan.',
    nextBestAction: 'Place call between 6 PM – 9 PM. Pitch ROI on earning potential and address relevance of AI skills for PMs.',
    conversionProbability: 88,
    temperature: 'Hot',
    fitScoreBreakdown: [
      { factor: 'Experience Fit', score: 95, reason: '5–8 years in project & program management is ideal target profile.' },
      { factor: 'Urgency Fit', score: 90, reason: 'Timeline stated as immediately.' }
    ],
    intentScoreBreakdown: [
      { factor: 'Career Urgency', score: 92, reason: 'Wants to increase earning potential immediately.' },
      { factor: 'Budget Objection', score: 70, reason: 'Mentions ₹34,999 outside budget; offer EMI structure.' }
    ],
    likelyDesiredOutcome: 'Transition from traditional PM execution to AI-orchestrated delivery with 30-50% earning uplift.',
    recommendedPositioning: 'Position AI-PM as an ROI-generating career catalyst rather than an academic course.',
    recommendedOpening: 'Hi Abhishek, saw you are leading program operations and looking to immediately boost your earning potential with practical AI skills. Calling to share how our PMs automate 40% of sprint reporting using agent workflows.',
    discoveryQuestions: [
      'Which daily PM tasks take up most of your bandwidth right now (sprint tracking, stakeholder updates, SOPs)?',
      'If you could automate manual status tracking and lead AI workflows, what salary or role tier are you targeting?'
    ],
    callNotesHistory: []
  },
  {
